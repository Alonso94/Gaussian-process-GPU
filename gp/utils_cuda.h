//
// Created by ali on 06.05.19.
//

#ifndef GP_GPU_UTILS_CUDA_H
#define GP_GPU_UTILS_CUDA_H
...
static dim3 div_ceil(dim3 a, dim3 b) {
    int x = div_ceil(a.x,b.x);
    int y = div_ceil(a.y,b.y);
    int z = div_ceil(a.z,b.z);
    return dim3(x,y,z);
}

static dim3 div_ceil(dim3 a, dim3 b, int multi) {
    int x = div_ceil(a.x,b.x*multi);
    int y = div_ceil(a.y,b.y*multi);
    int z = div_ceil(a.z,b.z*multi);
    return dim3(x,y,z);
}

/**************************/
//     magic(n) : O(n) shuffle an array using Fisher-Yates shuffle
/**************************/
